...
router.post('/heroes/nuevo', nuevoSuperHeroeController); //validarSuperHeroe, handleValidationErrors, 
router.put('/heroes/actualizar/:id',  actualizarSuperHeroeController); //validarSuperHeroe, handleValidationErrors,
