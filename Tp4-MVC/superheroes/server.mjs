...
import { obtenerSuperheroesPorIdController, buscarSuperheroePorAtributoController, obtenerSuperheroesPorIdController } from "./controllers/superheroesController.mjs"; 
...
app.get('/superheroes/edad/mayores30/', obtenerSuperheroesMayoresDe30);
